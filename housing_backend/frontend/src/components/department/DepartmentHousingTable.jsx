...
import {
  formatNum,
  formatPurchaseBasis,
  formatResidencePeriod,
} from "../../utils/apartmentRowData";
...
const COL_COUNT = 17 + HOUSING_DOCS.length;

export default function DepartmentHousingTable({ rows = [], title }) {
        ...
        <table className="table-excel">
          <thead>
            <tr>
              ...
              <th>Статус квартиры по приказу</th>
              ...
              filtered.map((row) => {
                ...
                return (
                  <tr key={apt.id}>
                    ...
                    <td className="complex-wt-num">{formatNum(marketPrice)}</td>
