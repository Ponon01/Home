...
class BudgetRentRecord(Base):
    __tablename__ = "budget_rent_records"

    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    
    valuation_object: Mapped[str | None] = mapped_column(String(255), nullable=True)
    residential_complex_name: Mapped[str | None] = mapped_column(String(255), nullable=True, index=True)
    street: Mapped[str | None] = mapped_column(String(255), nullable=True)
    house_number: Mapped[str | None] = mapped_column(String(255), nullable=True)
    ...
    total_area: Mapped[float | None] = mapped_column(Numeric(18, 4), nullable=True)
    living_area: Mapped[float | None] = mapped_column(Numeric(18, 4), nullable=True)
    ...
    land_tax_year_ownership_adjustment: Mapped[float | None] = mapped_column(Numeric(18, 2), nullable=True)
    ...
    contract_status: Mapped[str | None] = mapped_column(String(255), nullable=True)
    rental_contract_number_date: Mapped[str | None] = mapped_column(String(512), nullable=True)
