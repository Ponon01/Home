...
class BudgetRentRecordBase(BaseModel):
    valuation_object: str | None = None
    residential_complex_name: str | None = None
    ...
    land_tax_year_ownership_adjustment: float | None = None
    ...
    rental_contract_number_date: str | None = None
    attachment_note: str | None = None
    changes_note: str | None = None

class BudgetRentRecordRead(BudgetRentRecordBase):
    id: int
    created_at: datetime
    updated_at: datetime
